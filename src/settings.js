...
import {BackButton, PersonTag, SubTag} from './buttons';
      ...
      <KeyboardShift>
        <View style={styles.container}>
          ...
          <ListItem
            ...
            onPress={
              () => {}
              // this.getGroups() where is this defined @Ben
            }
            subtitle={
          ...
          <View style={styles.settingsTextItem}>
            ...
            <TouchableOpacity style={styles.xText}>
              <Text
                style={styles.labelText}
                onPress={() => {
                  this.props.route.params.logoutcallback();
                }}>
                Logout
              </Text>
            </TouchableOpacity>
